trigger genericFeedItemTrigger on FeedItem(before insert, after insert, before update, after update, before delete, after delete, after undelete) {
    ...
    if(!skiptrigger && !TriggerUtility.isSkipFeedItemTriggerExecuted() && tsmap != null && !tsmap.isEmpty() && tsmap.containsKey('Execute_FeedItem_Trigger') && tsmap.get('Execute_FeedItem_Trigger') != null && tsmap.get('Execute_FeedItem_Trigger').Execute__c){
